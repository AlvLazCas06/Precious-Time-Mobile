...
class _ProjectViewState extends State<ProjectView> {
  ...
  void initState() {
    super.initState();
    projectViewBloc = ProjectViewBloc(ProjectService())
      ...
      listener: (context, state) {
        ...
        if (state is ProjectViewCancelSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Proyecto cancelado exitosamente')),
          );
        }
                    ...
                    SizedBox(
                      ...
                      child: FloatingActionButton(
                        onPressed: state is ProjectViewLoading
                            ...
                            : () {
                                projectViewBloc.add(
                                  ProjectViewCancelEvent(id: int.parse(widget.id)),
                                );
                              },
                        backgroundColor: const Color.fromARGB(255, 221, 100, 100),
